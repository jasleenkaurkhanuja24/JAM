...
import com.mycompany.youtubee.dao.likesdao;
...
public class likeservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            boolean likes = ld.isalreadyliked(postid, email);
            if(likes==false)
            {
                boolean t = ld.insertnewlike(postid,email);
                if(t==true)
                {
                    out.println("likedone");
                }
                else
                {
            ...
            {
                out.println("likedeleted");
                ld.deletelike(postid, email);
            }
        }
    }
